...
# software:       Maya
#
# content:        adds mnu with functions to MAYA
#
# dependencies:   userSetup.py
#
...
def arMenuLoad():
      ...
      menu = cmds.menu(s.PROJECT_NAME.replace(" ",""), hm = 1, p = 'MayaWindow', l = s.PROJECT_NAME.replace(" ",""), to = 1, )

      #*************************
      # SAVE & LOAD
      #*************************
      cmds.menuItem(p = menu, l = 'arSave',c = 'from utilities import arSave\nreload(arSave)\narSave.start()')#, en = 0)
      cmds.menuItem(p = menu, l = 'arLoad',c = 'from utilities import arSaveAs\nreload(arSaveAs)\narSaveAs.start(True)')#, en = 0)
