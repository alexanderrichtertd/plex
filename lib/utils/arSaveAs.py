...
class ArSaveAs(ArUtil):
    def __init__(self, new_file=True):
        ...
        self.wgSaveAs = QtUiTools.QUiLoader().load(path_ui)
        ...
        self.wgHeader.setWindowIcon(QtGui.QIcon(libData.get_img_path("btn/btnFolderSearchSet48")))
    ...
    def setup(self):
        ...
        self.wgSaveAs.connect(self.wgSaveAs.cbxScene, QtCore.SIGNAL("currentIndexChanged(const QString&)"), self.change_cbxScene)
        self.wgSaveAs.connect(self.wgSaveAs.cbxTask, QtCore.SIGNAL("currentIndexChanged(const QString&)"), self.update_file)
    ...
    def change_cbxScene(self):
        ...
        try:
            ...
            if self.wgSaveAs.cbxSet.isVisible():
                self.wgSaveAs.cbxSet.addItems(libFileFolder.get_file_list(self.save_dir))
    ...
    def create_folder_structure(self):
        ...
        for folder in save_list: libFileFolder.create_folder(folder)
